...
createRoot(document.getElementById("root")).render(
  <StrictMode>
     <ThemeProvider>
       <div className="relative z-0  bg-gradient-to-r from-yellow-50 to-yellow-50 dark:from-yellow-900/20 dark:to-yellow-900/20 rounded-2xl mb-10 overflow-hidden shadow">
