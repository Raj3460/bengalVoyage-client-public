...
const TouristStoriesSection = () => {
  ...
  const { data: stories = [], isLoading , error,} = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosSecure.get('/stories-random?limit=4');
          ...
          stories.map((story) => {
            ...
            return (
              ...
              >
                ...
                {/* Story Content */}
                <div className="px-5 pt-1 flex flex-col flex-grow">
                  <h2 className="text-xl font-bold text-gray-800 mb-2 line-clamp-1">
                    {/* {story.title} */}
                  </h2>
                  <p className="text-gray-600 text-base pb-2 line-clamp-1 flex-grow">
                    {/* {story.description} */}
                  </p>
                    ...
                    <form onSubmit={handleCommentSubmit} className="mb-8">
                      <div className="flex space-x-3">
                        <input
                          ...
                          className="flex-1 border text-sm  md:text-xl border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                          aria-label="Comment input"
                        />
                        <button
                          type="submit"
                          className="bg-blue-600 text-sm text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
